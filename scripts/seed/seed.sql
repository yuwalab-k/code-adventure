...
それが K 回できたら「できる」、K 回できなかったら「できない」。', NULL, NULL, NULL, NULL, 1, '2026-05-20', '2026-07-10T11:16:43.526Z', '2026-07-10T11:16:43.526Z');
...
N = 8 のとき最大でも 1430 通り程度しかない。コンピューターにはあっという間。', NULL, NULL, NULL, NULL, 1, '2026-05-20', '2026-07-10T11:16:43.526Z', '2026-07-10T11:16:43.526Z');
...
木の直径は「どこか1つの都市から一番遠い都市を探し、そこからまた一番遠い都市を探す」2回の探索で求まる。都市が10万個あっても速く終わる。', NULL, NULL, NULL, NULL, 1, '2026-05-21', '2026-07-10T11:16:43.526Z', '2026-07-10T11:16:43.526Z');
...
の 3 つの数字だけで出せる。', NULL, NULL, NULL, NULL, 1, '2026-05-22', '2026-07-10T11:16:43.526Z', '2026-07-10T11:16:43.526Z');
...
60回 × B×B の行列の掛け算 = 速く答えが出る。', NULL, NULL, NULL, NULL, 1, '2026-06-09', '2026-07-10T11:16:43.526Z', '2026-07-10T11:16:43.526Z');
...
INSERT OR REPLACE INTO explanation_cards (id, problem_id, screen, position, title, body_md, variant) VALUES ('typical90_a_ec_s2_1', 'typical90_a', 's2', 1, 'なんで全部試すと遅いの？', 'ようかんの長さは最大10億cm。1cmずつ切る場所を試すと10億回かかってしまう。', 'bad');
INSERT OR REPLACE INTO explanation_cards (id, problem_id, screen, position, title, body_md, variant) VALUES ('typical90_a_ec_s2_2', 'typical90_a', 's2', 2, 'できる/できないで考える', '「全部のピースを◯cm以上にできる？」という質問に変えると、二分探索で約30回にしぼりこめる。', 'good');
INSERT OR REPLACE INTO checkpoint_questions (id, problem_id, screen, position, question_md, choices_json, correct_choice_index, explanation_md) VALUES ('typical90_a_cq_s2_1', 'typical90_a', 's2', 1, 'ようかんバーを1cmずつ全部試すと何が問題？', '["答えが求まらない","時間がかかりすぎる","メモリが足りない"]', 1, 'ようかんの長さは最大10億cmなので、1cmずつ試すと最大10億回の計算が必要になり、制限時間に間に合わない。');
INSERT OR REPLACE INTO explanation_cards (id, problem_id, screen, position, title, body_md, variant) VALUES ('typical90_a_ec_s4_1', 'typical90_a', 's4', 1, '線形探索のダメなところ', '1cmから順番に全部試すと、Lが10億のとき10億回のループが必要になり、制限時間に間に合わない。', NULL);
INSERT OR REPLACE INTO checkpoint_questions (id, problem_id, screen, position, question_md, choices_json, correct_choice_index, explanation_md) VALUES ('typical90_a_cq_s4_1', 'typical90_a', 's4', 1, '線形探索(1からLまで全部試す)の計算回数はどれくらい？', '["約30回","Lに比例した回数","N回だけ"]', 1, '1cmずつ順番に試すので、Lが大きくなるとそれだけ計算回数も増えてしまう。');
INSERT OR REPLACE INTO explanation_cards (id, problem_id, screen, position, title, body_md, variant) VALUES ('typical90_a_ec_s6_1', 'typical90_a', 's6', 1, '二分探索でなぜ速いのか', '「できる/できない」の境目を半分ずつしぼりこむので、10億が約30回のチェックで済む。', NULL);
INSERT OR REPLACE INTO checkpoint_questions (id, problem_id, screen, position, question_md, choices_json, correct_choice_index, explanation_md) VALUES ('typical90_a_cq_s6_1', 'typical90_a', 's6', 1, '二分探索が速い理由は？', '["ランダムに探すから","毎回半分にしぼりこむから","全部の答えを覚えているから"]', 1, '調べる範囲を毎回半分にしぼりこむので、10億という大きな範囲でも約30回で答えにたどりつける。');
INSERT OR REPLACE INTO explanation_cards (id, problem_id, screen, position, title, body_md, variant) VALUES ('typical90_b_ec_s2_1', 'typical90_b', 's2', 1, '全部のパターンを作ってから判定すると？', '長さNの文字列は「(」と「)」の2種類×N文字で2^N通りある。N=20なら約100万通りを全部作ってから正しいか判定すると無駄が多い。', 'bad');
INSERT OR REPLACE INTO explanation_cards (id, problem_id, screen, position, title, body_md, variant) VALUES ('typical90_b_ec_s2_2', 'typical90_b', 's2', 2, '作りながら諦める(バックトラッキング)', '「今まで置いた( の数」と「) の数」を管理しながら、条件を満たさなくなったらそこで打ち切る。無駄なパターンを最初から作らない。', 'good');
INSERT OR REPLACE INTO checkpoint_questions (id, problem_id, screen, position, question_md, choices_json, correct_choice_index, explanation_md) VALUES ('typical90_b_cq_s2_1', 'typical90_b', 's2', 1, '正しいカッコ列を作るとき、次に「)」を置いてよいのはどんなとき？', '["まだ何個でも置ける","今まで置いた「(」の数より「)」の数が少ないとき","文字数が半分を超えたとき"]', 1, '閉じていない「(」が残っているときだけ「)」を置ける。「(」より「)」が多くなると、おかしなカッコ列になってしまう。');
INSERT OR REPLACE INTO explanation_cards (id, problem_id, screen, position, title, body_md, variant) VALUES ('typical90_b_ec_s4_1', 'typical90_b', 's4', 1, '全部のパターンを生成する解法の問題点', '2^(2N)通りの文字列を全部作ってから判定すると、N=8でも65536通り。Nがもう少し大きくなると一気に間に合わなくなる。最初から正しい形だけを作れば無駄がない。', NULL);
INSERT OR REPLACE INTO checkpoint_questions (id, problem_id, screen, position, question_md, choices_json, correct_choice_index, explanation_md) VALUES ('typical90_b_cq_s4_1', 'typical90_b', 's4', 1, 'N=8のとき、全パターンを作ってから判定する方法は何通りのパターンを調べる？', '["8通り","2の16乗(65536)通り","16通り"]', 1, '長さ16文字(N×2)のカッコ列を全部作ると2^16=65536通り。バックトラッキングなら無駄な枝を作らないのでもっと少ない計算で済む。');
INSERT OR REPLACE INTO explanation_cards (id, problem_id, screen, position, title, body_md, variant) VALUES ('typical90_b_ec_s6_1', 'typical90_b', 's6', 1, 'なぜバックトラッキングだと辞書順になるの？', '「(」を先に試してから「)」を試すというルールにするだけで、自然と辞書順(小さい方から先)に答えが出てくる。', NULL);
INSERT OR REPLACE INTO checkpoint_questions (id, problem_id, screen, position, question_md, choices_json, correct_choice_index, explanation_md) VALUES ('typical90_b_cq_s6_1', 'typical90_b', 's6', 1, 'バックトラッキングで辞書順に出力するために大事なことは？', '["「)」を先に試す","「(」を先に試す","毎回ランダムな順で試す"]', 1, '「(」は「)」より辞書順で早い文字なので、「(」を先に試すことで自動的に小さい(早い)文字列から出力される。');
INSERT OR REPLACE INTO explanation_cards (id, problem_id, screen, position, title, body_md, variant) VALUES ('typical90_c_ec_s2_1', 'typical90_c', 's2', 1, '全部の2点間を調べると？', '都市が10万個あるとき、全部のペアを調べると10万×10万=100億回。とても間に合わない。', 'bad');
INSERT OR REPLACE INTO explanation_cards (id, problem_id, screen, position, title, body_md, variant) VALUES ('typical90_c_ec_s2_2', 'typical90_c', 's2', 2, '遠い2つの都市だけ見つければいい', '一番遠い2つの都市(木の直径)を見つけて道路をつなぐのが最適。BFSを2回するだけで見つかる。', 'good');
INSERT OR REPLACE INTO checkpoint_questions (id, problem_id, screen, position, question_md, choices_json, correct_choice_index, explanation_md) VALUES ('typical90_c_cq_s2_1', 'typical90_c', 's2', 1, 'N=100000のとき、全ペアを調べる方法は何回くらい計算が必要？', '["10万回","約100億回","2回"]', 1, '10万×10万=100億回。BFSを2回使う方法なら10万回程度で終わる。');
INSERT OR REPLACE INTO explanation_cards (id, problem_id, screen, position, title, body_md, variant) VALUES ('typical90_c_ec_s4_1', 'typical90_c', 's4', 1, '全頂点からBFSする解法の問題点', '全部の都市を出発点にしてBFSをすると、都市数×都市数の計算(O(N^2))が必要になり、Nが大きいと間に合わない。', NULL);
INSERT OR REPLACE INTO checkpoint_questions (id, problem_id, screen, position, question_md, choices_json, correct_choice_index, explanation_md) VALUES ('typical90_c_cq_s4_1', 'typical90_c', 's4', 1, '全頂点から毎回BFSする方法の計算量はどれくらい？', '["都市の数と同じ","都市の数の2乗","いつも同じ回数"]', 1, 'N個の都市それぞれからBFSするのでO(N^2)。Nが10万だと100億回になってしまう。');
INSERT OR REPLACE INTO explanation_cards (id, problem_id, screen, position, title, body_md, variant) VALUES ('typical90_c_ec_s6_1', 'typical90_c', 's6', 1, '2回のBFSで直径が求まる理由', '1回目のBFSでどこからでも一番遠い都市を見つけると、それが直径の端っこの1つになっている。2回目のBFSでそこからさらに一番遠い都市までの距離が直径。', NULL);
INSERT OR REPLACE INTO checkpoint_questions (id, problem_id, screen, position, question_md, choices_json, correct_choice_index, explanation_md) VALUES ('typical90_c_cq_s6_1', 'typical90_c', 's6', 1, '木の直径を求めるには何回BFSをすればいい？', '["1回","2回","都市の数だけ"]', 1, '1回目で直径の端点の1つを見つけ、2回目でその点からの最大距離(直径)を求める。合計2回でよい。');
INSERT OR REPLACE INTO explanation_cards (id, problem_id, screen, position, title, body_md, variant) VALUES ('typical90_d_ec_s2_1', 'typical90_d', 's2', 1, '毎回行と列を全部足すと？', 'マスが2000×2000=400万個あって、1マスごとに行(2000個)と列(2000個)を足すと、合計で約160億回の計算になってしまう。', 'bad');
INSERT OR REPLACE INTO explanation_cards (id, problem_id, screen, position, title, body_md, variant) VALUES ('typical90_d_ec_s2_2', 'typical90_d', 's2', 2, '先に行の合計・列の合計を計算しておく', '各行の合計・各列の合計を1回だけ計算しておけば、あとは「行の合計＋列の合計－自分の値」の足し算・引き算3回で答えが出る。', 'good');
INSERT OR REPLACE INTO checkpoint_questions (id, problem_id, screen, position, question_md, choices_json, correct_choice_index, explanation_md) VALUES ('typical90_d_cq_s2_1', 'typical90_d', 's2', 1, '各マスごとに毎回行と列を足していくと、H=W=2000のとき計算回数はおよそどれくらい？', '["4000回","400万回","160億回"]', 2, '1マスあたり(H+W)=4000回の計算が必要で、それを400万マス分行うので約160億回になる。');
INSERT OR REPLACE INTO explanation_cards (id, problem_id, screen, position, title, body_md, variant) VALUES ('typical90_d_ec_s4_1', 'typical90_d', 's4', 1, '毎回合計し直す解法の問題点', '行や列の合計をその場で毎回計算していると、同じ計算を何度も繰り返すことになり無駄が多い。', NULL);
INSERT OR REPLACE INTO checkpoint_questions (id, problem_id, screen, position, question_md, choices_json, correct_choice_index, explanation_md) VALUES ('typical90_d_cq_s4_1', 'typical90_d', 's4', 1, '同じ行の合計を何度も計算し直すのは、なぜ無駄なの？', '["答えが変わってしまうから","同じ結果を何度も計算して時間を無駄にするから","エラーになるから"]', 1, '行の合計は最初に1回計算しておけば、あとは覚えておいた値を使い回すだけでいい。毎回計算し直すと同じ作業を何千回も繰り返すことになる。');
INSERT OR REPLACE INTO explanation_cards (id, problem_id, screen, position, title, body_md, variant) VALUES ('typical90_d_ec_s6_1', 'typical90_d', 's6', 1, 'なぜ自分の値を1回引くの？', 'マス(i,j)の値は、行の合計にも列の合計にも含まれている。そのまま足すと2回数えてしまうので、1回分を引いて正しい合計に直す。', NULL);
INSERT OR REPLACE INTO checkpoint_questions (id, problem_id, screen, position, question_md, choices_json, correct_choice_index, explanation_md) VALUES ('typical90_d_cq_s6_1', 'typical90_d', 's6', 1, '答え＝行の合計＋列の合計－自分の値、となるのはなぜ？', '["自分の値が2回数えられてしまうから","計算を楽にするためのおまじない","問題文にそう書いてあるから"]', 0, 'マス自身の値は行の合計にも列の合計にも入っているので、そのまま足すと2重に数えてしまう。1回分引いて正しい値にする。');
INSERT OR REPLACE INTO explanation_cards (id, problem_id, screen, position, title, body_md, variant) VALUES ('typical90_e_ec_s2_1', 'typical90_e', 's2', 1, '全部のN桁の数を試すと？', '使える数字が9種類、桁数Nが最大10^18のとき、作れる数の総数はけた違いに多い。全部試すのは絶対に無理。', 'bad');
INSERT OR REPLACE INTO explanation_cards (id, problem_id, screen, position, title, body_md, variant) VALUES ('typical90_e_ec_s2_2', 'typical90_e', 's2', 2, '「余り」だけ覚えておけばいい', '今まで作った数がBで割ったときの余りだけを管理すれば、次にどの数字を足したらどの余りになるかが分かる。具体的な数字そのものを覚える必要はない。', 'good');
INSERT OR REPLACE INTO checkpoint_questions (id, problem_id, screen, position, question_md, choices_json, correct_choice_index, explanation_md) VALUES ('typical90_e_cq_s2_1', 'typical90_e', 's2', 1, 'N桁の数を全部作って確かめる方法がダメな理由は？', '["答えが合わないから","Nが最大10^18で、数が多すぎて絶対に間に合わないから","余りの計算がむずかしいから"]', 1, 'Nは最大10^18(100京)。1個ずつ確かめるだけで、とても現実的な時間では終わらない。');
INSERT OR REPLACE INTO explanation_cards (id, problem_id, screen, position, title, body_md, variant) VALUES ('typical90_e_ec_s4_1', 'typical90_e', 's4', 1, '1桁ずつN回ループする解法の問題点', '余りだけを管理する工夫をしても、N回(最大10^18回)のループをそのまま回すと、それだけで間に合わない。', NULL);
INSERT OR REPLACE INTO checkpoint_questions (id, problem_id, screen, position, question_md, choices_json, correct_choice_index, explanation_md) VALUES ('typical90_e_cq_s4_1', 'typical90_e', 's4', 1, '余りだけ管理する工夫をしても、1桁ずつN回ループするとダメなのはなぜ？', '["余りの計算が間違っているから","Nが最大10^18で、ループの回数が多すぎるから","メモリが足りないから"]', 1, '工夫は正しいが、10^18回のループはそのままでは終わらない。ループの回数自体を減らす工夫(繰り返し二乗法)が必要。');
INSERT OR REPLACE INTO explanation_cards (id, problem_id, screen, position, title, body_md, variant) VALUES ('typical90_e_ec_s6_1', 'typical90_e', 's6', 1, '繰り返し二乗法でなぜ速くなるの？', '「N-1回同じ計算をくり返す」代わりに、計算を2倍・2倍…と増やしていくことで、約60回の掛け算だけでN乗(10^18乗)を求められる。', NULL);
INSERT OR REPLACE INTO checkpoint_questions (id, problem_id, screen, position, question_md, choices_json, correct_choice_index, explanation_md) VALUES ('typical90_e_cq_s6_1', 'typical90_e', 's6', 1, '繰り返し二乗法を使うと、10^18回だった計算が何回くらいで済むようになる？', '["10^18回のまま","約60回","1回"]', 1, '2乗を繰り返すことで指数が倍々に増えていくので、log2(10^18)≈60回程度の掛け算で答えが求まる。');
